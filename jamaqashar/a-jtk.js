...
const DATA = [
{
  ...
  { id: 'af35', label: 'مَعَ الظهر' },
  { id: 'af32', label: 'فَرْضَ العَصْرِ' },
...
function App()
{
  return (
    ...
    React.createElement("div", { className: "app-bar__title" }, "Niat Sholat Ashar Jamak Takhir dengan Sholat Dhuhur"))),
