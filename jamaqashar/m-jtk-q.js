...
const DATA = [
{
  ...
  items: [
  { id: 'af35', label: 'مع لْعِشَاءِ' },
  { id: 'af37', label: 'قَصْرًا' },
  { id: 'af34', label: 'مَجْمُوْعًا' },
  { id: 'af36', label: 'جَمْعَ تَأْخِيْرِ' },
  { id: 'af32', label: 'فَرْضَ الْمَغْرِبِ' },
  { id: 'af33', label: 'ثَلَاثَ رَكَعَاتٍ' },
...
function App()
{
  return (
    ...
    React.createElement("div", { className: "app-bar__title" }, "Niat Sholat Maghrib Jamak Takhir dengan Sholat Isya sekaligus di Qashar"))),
