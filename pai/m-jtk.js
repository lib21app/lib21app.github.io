...
const DATA = [
{
  ...
  items: [
  { id: 'af33', label: 'ثَلاَثَ رَكَعَاتٍ' },
  { id: 'af35', label: 'مَعَ اْلعِشَاءِ' },
  { id: 'af32', label: 'فَرْضَ اْلمَغْرِبِ' },
...
function App()
{
  return (
    ...
    React.createElement("div", { className: "app-bar__title" }, "Niat Sholat Maghrib Jamak Takhir dengan Sholat Isya"))),
