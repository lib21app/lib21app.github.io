...
const DATA = [
{
  ...
  items: [
  { id: 'af32', label: 'فَرْضَ الْعِشَاءِ' },
  { id: 'af35', label: 'مع الْمَغْرِبِ' },
...
function App()
{
  return (
    ...
    React.createElement("div", { className: "app-bar__title" }, "Niat Sholat Isya Jamak Takhir dengan Sholat Maghrib sekaligus di Qashar"))),
